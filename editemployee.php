...
<html lang="en">
 ...
 Employee Data Updated Successfully!!
		...
		?>
	<form id="emp_upd" action='editemployee.php' method="POST"> 
	...
	echo "</tr></thead>";
		foreach($main_decode["users"] as $key=>$users)
		{
			...
			<td><input type='text' value='".$users["name"]."' class='form-control' title='$key' name='".$key."_name'></td>
			
			<td><input type='text' value='".$users["pay"]." ' name='".$key."_pay' class='form-control'></td><td><input type='text' value='".$users["role"]."' name='".$key."_role' class='form-control'</td><td><input type='text' value='".$users["phone"]."' name='".$key."_phone' class='form-control'</td>
